...
public class ModConfigs {
    ...
    public ModConfigs(final ForgeConfigSpec.Builder builder) {
        ...
        ENDER_NACRE_DROP_PROBABILITY = builder
                ...
                .defineInRange("ender_nacre_drop_probability", 0.5, 0, 1);
        builder.pop();
    }
}
